          ...
          <div className="container mx-auto max-w-6xl pt-12">
            <div className="max-w-3xl">
              ...
              <div className="flex gap-4 flex-wrap">
                <Link href="https://services.iroh.computer?utm_source=website&utm_content=hosting-hero">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-lg border border-irohPurple-500 bg-irohGray-100 dark:bg-irohGray-800">
                ...
                <Link href="https://services.iroh.computer?utm_source=website&utm_content=hosting-cloud" className="text-irohPurple-500 hover:underline font-medium">
                  Start 30 day trial →
                </Link>
              </div>
        ...
        <section className="py-20 px-6 border-t border-irohGray-300 dark:border-irohGray-800">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="https://services.iroh.computer?utm_source=website&utm_content=hosting-cta">
                  <Button arrow="none" className="bg-irohGray-800 hover:bg-irohGray-700 text-irohPurple-500 px-6 py-2 text-sm font-medium cursor-pointer">
                    Start 30 day trial
                  </Button>
                </Link>
