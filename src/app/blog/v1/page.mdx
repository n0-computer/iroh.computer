...
- We built on our own implementation of [QUIC multipath][quic-multipath], so iroh can build & manage multiple routes within the same connection, and hot swap paths as conditions change
