...
With this release, our fork has graduated into its own project: [`noq`](https://github.com/n0-computer/noq). This isn't just a rename - it reflects the reality that our QUIC implementation has its own direction and goals. All internal references have been updated from `quinn` to `noq`, and types are now re-exported from `noq` directly.
