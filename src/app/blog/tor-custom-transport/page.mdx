...
But we do not want to add additonal transports to the iroh codebase. That would make the code very complex with a maze of feature flags, add a lot of dependencies that most of our customers don't need, and it likely _still_ would not cover all transports that people might want.
