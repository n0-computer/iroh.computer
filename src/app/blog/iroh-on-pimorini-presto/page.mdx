...
export const post = {
  ...
  date: '2026-09-14',
  title: 'Running rust std and iroh on rpi Pico 2/Pimoroni Presto',
  description: 'Iroh currently does not support nostd. ',
}
...
proof of concept hack, but we offer  production-level support for the RP2040: just [contact us](mailto:support@iroh.computer). 
