...
In the [next blog post](/blog/quic-packet-rejection-in-practice) we implement a small iroh echo server and torture it with random and specially crafted UDP spam to see how all of this works in the real world!
