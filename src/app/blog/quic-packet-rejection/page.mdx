...
At the wire level, disregarding relays and custom transports for a bit, QUIC is using UDP datagrams. QUIC is reading individual datagrams from the operating system and then interprets them as higher level QUIC primitives, connections and streams.
