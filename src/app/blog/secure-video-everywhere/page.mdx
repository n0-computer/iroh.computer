...
Now let's implement a simple 0rtt service in iroh. It is going to be a simple echo service, where we just read a tiny request and echo it back byte for byte.
