...
<Note>
[Sendme](https://github.com/n0-computer/sendme) contains a lot of examples on how to provide progress for adding, transfering, and exporting files from blobs.
</Note>
