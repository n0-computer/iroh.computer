...
The client fn can then transform these two handles for the update and response end to make the result more convenient, e.g. by converting the result into a futures [`Stream`].
