...
For existing error types like io::Error, you can write a serializable wrapper - an io error consists of a Kind and a message, both of which are serializable.
