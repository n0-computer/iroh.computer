...
iroh has been using out implementation of [QUIC Address Discovery](https://datatracker.ietf.org/doc/draft-ietf-quic-address-discovery/) (QAD) since iroh version 0.32.
...
preventing protocol ossification and enhanced user privacy.
