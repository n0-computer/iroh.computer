...
export const post = {
  ...
  author: 'ramfox,',
  date: '2024-05-13',
  title: 'Iroh 0.16 - Better APIs, round 1!',
...
<div className="not-prose">
  <Image src="/blog/iroh-0-16-better-apis-round-1/iroh-doctor-plot.png" width={1200} height={754} alt="iroh plot doctor" />
</div>
