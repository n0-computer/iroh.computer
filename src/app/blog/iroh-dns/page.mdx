...
We want iroh to establish connections with as little friction as possible. We’ve been chipping away at this goal since our inception. Our first big push toward this goal was to add holepunching into iroh, removing the need for devs to worry about opening up ports on their servers or resigning themselves to only making peer-to-peer connections to computers inside their local NAT.
...
<div className='not-prose mb-5'>
  <MotionCanvas src='/motion-canvas/Publishing.project.js' />
</div>
...
<div className='not-prose mb-5'>
  <MotionCanvas src='/motion-canvas/Discovery.project.js' />
</div>
