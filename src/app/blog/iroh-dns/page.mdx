...
export const post = {
  ...
  description: 'iroh-dns uses domain name servers to resolve dialing details, so you can dial any device by its node identifier',
}
...
<div className='not-prose mx-auto max-w-2xl mb-5'>
