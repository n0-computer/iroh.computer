...
Iroh’s networking stack can do a lot of clever things. It can allow you to dial by NodeID, using [certain discovery mechanisms]([https://iroh.computer/blog/iroh-dns](https://iroh.computer/blog/iroh-dns)). It allows you to communicate with another machine, even if your computer and the other computer are each behind a NAT, using hole punching. 
