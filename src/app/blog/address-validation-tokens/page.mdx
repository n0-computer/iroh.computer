...
A real handshake that fits: `www.cloudflare.com`, 41 ms, server response 4.4 KiB but actually 3.4 KiB on the wire — under the cap. [Inspect the qlog.](/blog/address-validation-tokens/handshake-no-stall.qlog)
