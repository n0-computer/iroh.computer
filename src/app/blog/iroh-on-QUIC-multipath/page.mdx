...
<div className="not-prose">
    <ThemeImage
        lightSrc='/blog/iroh-on-QUIC-multipath/mp_light.png'
        darkSrc='/blog/iroh-on-QUIC-multipath/mp_dark.png'
        alt='a phone and a laptop connected by cloud, cellular, and wifi paths through the internet'
        width={800}
        height={300}
      />
</div>
