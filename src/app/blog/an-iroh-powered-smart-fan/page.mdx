...
As the base we are going to use an ESP32-WROVER devkit with 4 MiB of PSRAM, so we can use full iroh including a relay connection and remote control it from anywhere in the world. You can also use a M5StickC-Plus2.
