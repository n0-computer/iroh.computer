...
To run the GUI, go into smart-fan-wasm and run `npm run build; npm run serve`, and then open the GUI on `localhost:8080`. But you don't have to! The GUI in this blog post is live, you can just paste your ticket and try it out.
