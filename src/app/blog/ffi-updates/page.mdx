...
Deciding on a path forward is part of our [1.0 roadmap](/release), which is slated to come out in the 2nd half of 2025, you can subscribe for updates here, or keep an eye on the [changelog](/changelog).
