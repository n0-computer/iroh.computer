...
But we did not have an easy to use way to authwnticate endpoints to relays, to ensure you control who connects to your relays. 

An unauthenticated relay is an open door. Anyone who learns the URL can point their endpoints at it and ride your capacity. Your usage can be misattributed by someone else connecting through your relay. On the public internet, "we didn't advertise the URL" is not access control.
