  ...
  return (
    <div className='max-w-3xl mx-auto'>
      <Prose>
        ...
        <p>Iroh Protocols are pluggable extensions that build on direct connections. Like HTTP server middleware on steriods! Mix & match for fast, flexible, functionality.</p>
      </Prose>
      <div className="not-prose">
        <div className="mb-16 mt-6 flex gap-3">
          <Button href="/docs/protocols" arrow="right">Protocols Overview</Button>
          <Button href="/docs/protocol-quickstart" variant="outline">Write a protocol</Button>
        </div>
      </div>
      <div>
