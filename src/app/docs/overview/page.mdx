...
<Concepts>
  <Concept name="Documents" href="/docs/protocols/documents" description="Collaborate on shared key-value tables of blobs with peers." />
  <Concept name="Blobs" href="/docs/protocols/blobs" description="Fetch and cache byte sequences by their hash." />
  <Concept name="Gossip" href="/docs/protocols/gossip" description="Broadcast messages to a swarm of peers." />
  <Concept name="Net" href="/docs/protocols/net" description="Open a connection to any available peer on the network." />
</Concepts>
