      ...
      <div className="max-w-6xl mx-auto px-4 lg:mt-100">
        <div className="mt-14 min-h-[70vh] sm:w-2/3 lg:w-1/2">
          ...
          <div className='flex mt-3'>
            <a href="/beta" className="my-4 p-3 px-4 transition bg-irohGray-800 text-irohPurple-500 uppercase hover:bg-irohGray-700 hover:text-gray-200 plausible-event-name=Home+Join+Beta+Click">Join the Beta</a>
