    ...
    <section className="min-h-92 bg-iroh-kv-1 pt-40 bg-cover">
      <div className="max-w-6xl mx-auto px-4 lg:mt-100">
        <div className="mt-14 min-h-[70vh] sm:w-2/3 lg:w-1/2">
          ...
          <h3 className="text-md font-space-mono mt-3 text-gray-700 leading-normal">Iroh is a toolkit for building distributed apps. Open source and universally compatible, it&apos;s the quickest route from concept to connected devices.</h3>
