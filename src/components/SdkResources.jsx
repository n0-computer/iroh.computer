...
export function SdkResources({ language, packageManagerUrl, languageDocsUrl, githubUrl, resources = [] }) {
  if (packageManagerUrl) {
    resources.push({
      href: packageManagerUrl,
      name: `${language} Package`,
      description: `Learn ${language} with the ${language} docs`,
