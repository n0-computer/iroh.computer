    ...
    <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
      {protocols.filter((p) => !!p.featured).map((proto, i) => (
        <Link href={proto.href} key={i}>
          <GlowCard className='p-5 h-full border border-irohGray-300 dark:border-irohGray-800 rounded-lg'>
            <Image
      ...
      <GlowCard className='p-5 border border-irohGray-300 dark:border-irohGray-800 rounded-lg'>
